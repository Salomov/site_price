...
/**
 * @file
 * Contains \Drupal\site_price\Form\ConfirmPricePositionDeleteForm
 */
 ...
 */
class ConfirmPricePositionDeleteForm extends ConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete «@title»?', array('@title' => $this->position->title));
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->databasePrice->deletePricePosition($this->position->pid);

    // Очищает cache.
    Cache::invalidateTags(['price']);

    drupal_set_message($this->t('Position deleted.'));
